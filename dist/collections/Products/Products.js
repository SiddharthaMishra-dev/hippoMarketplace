...
var isAdminOrHasAccess = function () {
    return function (_a) {
        ...
        if (user.role === "admin")
            return true;
        var userProducts = (user.products || []).reduce(function (acc, product) {
            if (!product)
                return acc;
...
exports.Products = {
    ...
    hooks: {
        ...
        beforeChange: [
            addUser,
            function (arg) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createdProduct, updated, data, updatedProduct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(arg.operation === "create")) return [3 /*break*/, 2];
                            data = arg.data;
                        ...
                        case 2:
                            if (!(arg.operation === "update")) return [3 /*break*/, 4];
                            data = arg.data;
