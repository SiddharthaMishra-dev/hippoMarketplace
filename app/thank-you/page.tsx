      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24 ">
          <div className="lg:col-start-2 ">
            <p className="text-sm font-medium text-orange-500">Order successful</p>
            <h1 className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
              Thanks for ordering
            </h1>
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order is processed and your assets are available to download below. We&apos;ve
              ...
              <p className="mt-2 text-base text-muted-foreground">
                We appreciate your order, and we&apos;re currently processing it. Hang tight,
                we&apos;ll send you confirmation mail soon!
              </p>
            )}
            ...
            <div className="mt-16 text-sm font-medium ">
              ...
              <ul className="mt-6 divide-y divide-gray-200 border-t border-gray-900 text-sm font-medium text-muted-foreground">
              ...
              <div className="space-y-6 font-medium border-t border-gray-200 pt-6 text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                  ...
                  <p className="text-base">{formatPrice(orderTotal + 30)}</p>
                </div>
              </div>
              ...
              <div className="mt-16 border-t border-gray-200 text-right py-6">
                <Link
                  href="/products"
                  className="text-sm text-oraange-500 text-orange-500 hover:text-orange-400 font-medium"
                >
