...
const MobileNav = () => {
  ...
  const closeOnClick = (href: string) => {
    if (pathname === href) {
      setIsOpen(false);
    }
  };
  ...
  return (
    <div>
      ...
      <div className="fixed overflow-y-scroll overflow-y-none inset-0 flex z-40">
        <div className="w-4/5">
